  ...
  return (
    <PageContainer>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-10">
        <Card>
          <p className="text-[10px] font-mono text-gray-500 uppercase tracking-wider mb-1">1. Overall Preliminary Risk</p>
        ...
        <Card>
          <p className="text-[10px] font-mono text-gray-500 uppercase tracking-wider mb-1">2. Evidence Confidence</p>
          <p className="text-lg font-mono font-bold text-gray-900">{confidence.level} ({confidence.percent}%)</p>
        </Card>
        <Card>
          <p className="text-[10px] font-mono text-gray-500 uppercase tracking-wider mb-1">3. Operational Master Function</p>
          <p className="text-sm text-gray-900">{mf.operational.join(", ")}</p>
        </Card>
        <Card>
          <p className="text-[10px] font-mono text-gray-500 uppercase tracking-wider mb-1">4. Contradiction Index</p>
          <p className="text-lg font-mono font-bold text-gray-900">{contradiction.index}</p>
        </Card>
        <Card>
          <p className="text-[10px] font-mono text-gray-500 uppercase tracking-wider mb-1">5. Responsibility Clarity</p>
          <p className="text-lg font-mono font-bold text-gray-900">{risk.capacityDomains.responsibility_generation}/4</p>
        </Card>
        <Card>
          <p className="text-[10px] font-mono text-gray-500 uppercase tracking-wider mb-1">6. Appealability</p>
          <p className="text-lg font-mono font-bold text-gray-900">{risk.capacityDomains.appealability}/4</p>
        </Card>
        <Card>
          <p className="text-[10px] font-mono text-gray-500 uppercase tracking-wider mb-1">7. Re-entry Capacity</p>
          <p className="text-lg font-mono font-bold text-gray-900">{risk.capacityDomains.re_entry_capacity}/4</p>
        </Card>
        <Card>
          <p className="text-[10px] font-mono text-gray-500 uppercase tracking-wider mb-1">8. Future Closure Risk</p>
          <p className="text-lg font-mono font-bold text-gray-900">{risk.riskDomains.future_closure}/4</p>
        </Card>
        <Card>
          <p className="text-[10px] font-mono text-gray-500 uppercase tracking-wider mb-1">9. Primary Missing Evidence</p>
        ...
        <Card>
          <p className="text-[10px] font-mono text-gray-500 uppercase tracking-wider mb-1">10. Recommended Immediate Action</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
        <Card>
          <p className="text-[10px] font-mono font-bold tracking-[0.2em] text-gray-500 uppercase mb-3">Risk Domains</p>
          {Object.entries(risk.riskDomains).map(([k, v]) => <Row key={k} label={k} value={v} />)}
        </Card>
        <Card>
          <p className="text-[10px] font-mono font-bold tracking-[0.2em] text-gray-500 uppercase mb-3">Positive Capacity Domains</p>
      ...
      {risk.adjustmentsApplied.length > 0 && (
        <div className="mb-10">
          <p className="text-[10px] font-mono font-bold tracking-[0.2em] text-gray-500 uppercase mb-3">Upward Adjustments Applied</p>
