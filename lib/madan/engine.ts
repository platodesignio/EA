...
export function generateAgentDisagreements(agents: AuditAgent[], scenario: AuditScenario): AgentDisagreement[] {
  ...
  if (bla && syn && s.surveillanceLoad > 0.3) {
    disagreements.push({
      ...
      positionA: bla.analysisOutput?.slice(0, 160) ?? "Body-Load Auditor: Chronic stress, self-censorship, and anticipatory compliance costs are real and compounding but not captured in the Directional Correctness Index (DCR).",
