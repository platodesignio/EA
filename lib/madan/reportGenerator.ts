...
**Directional Correctness Index (DCR):** ${dcrSign}${result.dcr.toFixed(2)} / ±5.00

---

## Executive Summary

The Multi-Perspective Audit Module conducted a full twelve-perspective structured audit of **${scenario.title}**. The audit produced a Directional Correctness Index (DCR) of **${dcrSign}${result.dcr.toFixed(2)}**, yielding a directional judgment of **${result.finalJudgment}**.
